...
async function saveEntry(){
  ...
  const row={ item:document.getElementById('item').value, batch:document.getElementById('batch').value, receivingDate:document.getElementById('receivingDate').value, mfgDate:document.getElementById('mfgDate').value, expiryDate:document.getElementById('expiryDate').value, shelfLife:document.getElementById('shelfLife').value, qty:document.getElementById('qty').value, remarks:document.getElementById('remarks').value };
